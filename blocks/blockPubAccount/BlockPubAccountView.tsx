...
const BlockPubAccountView: FC<BlockViewProps> = () => {
  ...
  const onSignout = async () => {
    ...
    try {
      ...
      await signOut({
        redirect: false,
        callbackUrl: `${window?.location?.hostname}/sign-in`,
      });
      router.push(`/sign-in`);
    } finally {
      setLoaderMessage("");
  ...
  const userHasFreeSubscription =
    subscriber?.stripeSubscriptions?.[0]?.id === "freeSubscriptionId"; // TODO: change freeSubscriptionId
  const stripeSubscription = session?.user
    .stripeSubscriptions?.[0] as Stripe.Subscription;
  ...
  return (
    <>
          ...
          <div className="account-header">
            ...
            <div className="horizonta-row">
              ...
              {userIsSubscribed && (
                ...
                >
                  <div
                    data-w-id="54bbd209-da76-b145-1cd4-02ae54b1eb4b"
                    className="icon ben-brand w-embed"
                  >
              ...
              >
                <div
                  data-w-id="58ec2b1b-21c3-c908-7180-403003866f18"
                  className="icon ben-brand w-embed"
                >
              ...
              <>
                ...
                <div className="card">
                  <div className="card-heading-small">
                    ...
                    <p className="qui-brand">
                      Before deleting you account, you must cancel your
                      subscription.
                    </p>
                  </div>
                  <a
                ...
                {userIsLegacySubscriber && (
                  <div className="card">
                    ...
                    <p className="body1-brand _50ch">
                      Your subscription has been created before Dec 1st 2021,
                      and is using our legacy payment center. Please write
                      customer support to <a>change</a> or <a>delete</a> your
                      subscription or call us:
      ...
      <div
        ...
        style={{
          display: isSubscriptionOpen || isDeleteAccountOpen ? "flex" : "none",
        }}
      >
        <OutsideClickHandler
          onOutsideClick={(e) => {
        ...
        >
          <div className="popup sue-background-brand center-align">
            ...
            <div className="popup-content roy-background-brand">
              {isSubscriptionOpen && (
                <div
                  data-w-id="5c4389c1-19a1-6969-b851-5695a78bb33d"
                  className="center-align"
                >
                  <h3>Choose a new plan</h3>

                  <p>
                    Accounts created prior Nov 26 2021 must be changed by the
                    Semissourian.
                  </p>
                  ...
                  <ul>
                    ...
                    <li>
                      <a style={{ cursor: "pointer" }}>
                        ...
                        {formatToPrice(stripePlans.digital.price)} /{" "}
                    ...
                    <li>
                      <a style={{ cursor: "pointer" }}>
                        ...
                        {formatToPrice(stripePlans.digitalPlus.price)} /{" "}
              ...
              {isDeleteAccountOpen && (
                <div
                  data-w-id="315634f4-8a00-c92e-f3f8-e943078ffac4"
                  className="center-align"
                >
                  <h3>Delete Account?</h3>
                  <p className="body1-brand _50ch">
                    To access SEMissourian in the future you will need to create
